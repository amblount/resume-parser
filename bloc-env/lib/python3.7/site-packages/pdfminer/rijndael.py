...
def rijndaelSetupEncrypt(key, keybits):
    ...
    if keybits == 128:
        while True:
            temp = rk[p + 3]
            rk[p + 4] = (
                rk[p + 0] ^ (Te4[(temp >> 16) & 0xff] & 0xff000000) ^ (Te4[(temp >> 8) & 0xff] & 0x00ff0000) ^
    ...
    if keybits == 256:
        while True:
            ...
            temp = rk[p + 11]
            rk[p + 12] = (
                rk[p + 4] ^ (Te4[(temp >> 24)] & 0xff000000) ^ (Te4[(temp >> 16) & 0xff] & 0x00ff0000) ^
...
def rijndaelSetupDecrypt(key, keybits):
    ...
    for i in range(1, nrounds):
        p += 4
        rk[p + 0] = (
            Td0[Te4[(rk[p + 0] >> 24)] & 0xff] ^ Td1[Te4[(rk[p + 0] >> 16) & 0xff] & 0xff]
            ^ Td2[Te4[(rk[p + 0] >> 8) & 0xff] & 0xff] ^ Td3[Te4[(rk[p + 0]) & 0xff] & 0xff])
        rk[p + 1] = (
            Td0[Te4[(rk[p + 1] >> 24)] & 0xff] ^ Td1[Te4[(rk[p + 1] >> 16) & 0xff] & 0xff]
            ^ Td2[Te4[(rk[p + 1] >> 8) & 0xff] & 0xff] ^ Td3[Te4[(rk[p + 1]) & 0xff] & 0xff])
        rk[p + 2] = (
            Td0[Te4[(rk[p + 2] >> 24)] & 0xff] ^ Td1[Te4[(rk[p + 2] >> 16) & 0xff] & 0xff]
            ^ Td2[Te4[(rk[p + 2] >> 8) & 0xff] & 0xff] ^ Td3[Te4[(rk[p + 2]) & 0xff] & 0xff])
        rk[p + 3] = (
            Td0[Te4[(rk[p + 3] >> 24)] & 0xff] ^ Td1[Te4[(rk[p + 3] >> 16) & 0xff] & 0xff]
            ^ Td2[Te4[(rk[p + 3] >> 8) & 0xff] & 0xff] ^ Td3[Te4[(rk[p + 3]) & 0xff] & 0xff])
